              ...
              <Row>
                <Col span="24">
                  <FormItem label="二、基本要求:  "    class="label">
                    <Input v-model="formItem.taskRequire" readonly type="textarea" :autosize="{minRows: 4,maxRows: 10}" size="large"  placeholder="基本要求"></Input>
                </FormItem>
                </Col>
              </Row>
                <Row>
                <Col span="24">
                  <FormItem label="三、工作进度安排:  "    class="label">
                    <Input v-model="formItem.taskSchedule" readonly type="textarea" :autosize="{minRows: 4,maxRows: 10}" size="large"  placeholder="工作进度安排"></Input>
                </FormItem>
                </Col>
              </Row>
               <Row>
                <Col span="24">
                  <FormItem label="四、应收集资料及主要参考文献:  "    class="label">
                    <Input v-model="formItem.taskLiterature" readonly type="textarea" :autosize="{minRows: 4,maxRows: 10}" size="large"  placeholder="应收集资料及主要参考文献"></Input>
                </FormItem>
                </Col>
              </Row>
          </Form>
