...
import com.graduationaldesign.graduation.shiro.MyRealm;
import com.graduationaldesign.graduation.shiro.StatelessDefaultSubjectFactory;
import com.graduationaldesign.graduation.shiro.filter.JWTFilter;
...
//        myShiroRealm.setCacheManager(redisCacheManager());
    ...
    public SecurityManager securityManager(@Qualifier("myRealm") MyRealm myRealm,
            @Qualifier("subjectDAO") DefaultSubjectDAO
                    subjectDAO, @Qualifier("sessionManager") DefaultSessionManager sessionManager,
