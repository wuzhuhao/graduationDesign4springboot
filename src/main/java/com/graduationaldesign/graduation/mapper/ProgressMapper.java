...
public interface ProgressMapper {
     ...
     * @param example
     */
    int updateByExampleSelective(@Param("record") Progress record,
            @Param("example") ProgressExample example);
     ...
     * @param example
     */
    int updateByExampleWithBLOBs(@Param("record") Progress record,
            @Param("example") ProgressExample example);
     ...
     * @param example
     */
    int updateByExample(@Param("record") Progress record,
            @Param("example") ProgressExample example);
