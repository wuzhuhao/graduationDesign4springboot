...
public class SubjectController{
    ...
    public ResponseEntity<Object> getSubjectOfNotChoice(@RequestParam HashMap<String,Object> params,int page){
    ...
    public ResponseEntity<Object> getSubjectOfChoice(@RequestParam HashMap<String,Object> params,int page){
        System.out.println(((Student) request.getSession().getAttribute("LOGIN_USER")));
        return ResponseStatu.success(subjectService.listByPageOfChoice(params,page,((Student) request.getSession().getAttribute("LOGIN_USER"))));
    }
    ...
    public ResponseEntity<Object> getSubjectOfTea(@RequestParam HashMap<String,Object> params,int page){
        return ResponseStatu.success(subjectService.listByPageOfTea(params,page,((Teacher) request.getSession().getAttribute("LOGIN_USER"))));
    }
    ...
    public ResponseEntity<Object> choiceSubject(String subId){
        try {
            return ResponseStatu.success(subjectService.ChoiceSubject(subId, (Student) request.getSession().getAttribute("LOGIN_USER")));
    ...
    public ResponseEntity<Object> cancelChoice(String subId){
        try {
            return ResponseStatu.success(subjectService.cancelChoice(subId, (Student) request.getSession().getAttribute("LOGIN_USER")));
        } catch (ClassCastException e) {
            return ResponseStatu.failure("用户异常，请重新登陆");
        }
    }
